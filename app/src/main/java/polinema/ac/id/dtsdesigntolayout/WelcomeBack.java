...
public class WelcomeBack extends AppCompatActivity {
    ...
    EditText editTextEmail; // Deklarasi variabel editTextEmail dengan tipe EditText

    EditText editTextPassword;// Deklarasi variabel editTextPassword dengan tipe EditText
